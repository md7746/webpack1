...
var PATHS = {
     ...
     * （发布目录）
     * */
    publicPath: devServer ? '/webpackForComponents/dist/' : './',
     ...
     * （src2 目录）
     * */
    srcPath: path.resolve(process.cwd(), 'src2'),
...
var resolve = {
    ...
    alias: {
         ...
         * js
         */
        jquery: path.join(PATHS.libsPath, "jquery"),
        commonjs: path.join(PATHS.srcPath, "js/common"),


        /*
         * css
         */
        commoncss: path.join(PATHS.srcPath, "style/common.css"),
        indexcss: path.join(PATHS.srcPath, "style/index.css")
    }
}
...
var entry = {
    index: './src2/index.js',
    common: [
        path.join(PATHS.libsPath, "jquery.js"),
        path.join(PATHS.srcPath, "js/common.js")
    ],
};
...
var output = {
     ...
     * （按需加载模块时输出的文件名称）
     * */
    chunkFilename: devServer ? 'components/[name]/[name].js' : 'components/[name]/[name]-[chunkhash:8].js'
}
...
var plugins = [
     ...
     * （提取css文件到单独的文件中）
     */
    new ExtractTextPlugin(devServer ? "style/[name].css" : "style/[name]-[chunkhash:8].css", {allChunks: true}),
    ...
    new HtmlWebpackPlugin({
        filename: 'index.html',
        template: __dirname + '/src2/index.html',
        /*
    ...
    new HtmlWebpackPlugin({
        ...
        template: __dirname + '/src2/components/about/about.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'components/case/case.html',
        template: __dirname + '/src2/components/case/case.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'components/contact/contact.html',
        template: __dirname + '/src2/components/contact/contact.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'components/dynamic/dynamic.html',
        template: __dirname + '/src2/components/dynamic/dynamic.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'components/history/history.html',
        template: __dirname + '/src2/components/history/history.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'components/service/service.html',
        template: __dirname + '/src2/components/service/service.html',
        inject: false,
    })
];
